...
const colorClass = computed(() => {
  switch (props.color) {
    ...
    case 'green':
      ...
      labelClass.value = `${props.card ? 'bg-green-50' : ''} border-green-500`;
    ...
    case 'blue':
      ...
      labelClass.value = `${props.card ? 'bg-blue-50' : ''} border-blue-500`;
...
const roundedClass = computed(() => {
  return props.pills ? 'rounded-lg my-2 mx-1' : 'rounded-t mt-4';
});
